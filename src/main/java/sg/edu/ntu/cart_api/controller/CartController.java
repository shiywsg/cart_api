...
public class CartController {
    ...
    public ResponseEntity<List<Cart>> findAll(@RequestHeader("user_id") int userId){
    ...
    public ResponseEntity add(@PathVariable int productId, @RequestParam Optional<Integer> quantity, @RequestHeader("user_id") int userId){
        try{
    ...
    public ResponseEntity decrement(@PathVariable int productId, @RequestHeader("user_id") int userId){
